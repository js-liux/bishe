...
h(b).insertBefore(a);a.innerHTML="";k.remove(a);UM.clearCache(this.id);for(var c in this)this.hasOwnProperty(c)&&delete this[c]},initialCont:function(a){if(a){a.getAttribute("name")&&(this.options.textarea=a.getAttribute("name"));if(a&&/script|textarea/ig.test(a.tagName)){var b=document.createElement("div");a.parentNode.insertBefore(b,a);this.options.initialContent=UM.htmlparser(a.value||a.innerHTML||this.options.initialContent).toHtml();a.className&&(b.className=a.className);a.style.cssText&&(css\6_(b.style.cssText=
...
a);return a.toHtml(e)},getAllHtml:function(){var a=[];this.fireEvent("getAllHtml",a);if(m.ie&&8<m.version){var b="";n.each(this.document.styleSheets,function(a){b+=a.href?'<link rel="stylesheet" type="text/css" href="'+a.href+'" />':"<style>"css\7_+a.cssText+"</style>"});n.each(this.document.getElementsByTagName("script"),function(a){b+=a.outerHTML})}return"<html><head>"+(this.options.charset?'<meta http-equiv="Content-Type" content="text/html; charset='+this.options.charset+'"/>':"")+(b||this.document.getElementsByTagName("head")[0].innerHTML)+
...
{html:a.toHtml()};d.fireEvent("beforepaste",b,a);b.html&&(css\8_(d.execCommand("insertHtml",b.html,!0),d.fireEvent("afterpaste",b))}}var d=this;d.addListener("ready",function(){h(d.body).on("cut",function(){!d.selection.getRange().collapsed&&d.undoManger&&d.undoManger.save()}).on(m.ie||m.opera?"keydown":"paste",function(c){(!m.ie&&!m.opera||(c.ctrlKey||c.metaKey)&&"86"==c.keyCode)&&a.call(d,function(a){b(a)})})})};UM.plugins.list=function(){this.setOpt({insertorderedlist:{decimal:"","lower-alpha":"","lower-roman":"",
...
this.root()).each(function(){var b=h(this);!0===a?b.addClass("edui-disabled"):h.isFunction(a)?b.toggleClass("edui-disable