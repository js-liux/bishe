    ...
    Dialog.prototype = {
        ...
        __getElement: function () {
            ...
            if (this.options.isAlert) {
                element.find('.wrapper').append('<div class="footer clr"><button class="ok gbutton ' + this.options.okClass + ' gbutton-small">' + this.options.okText + '</button></div>')
            }
            if (this.options.isConfirm) {
                element.find('.wrapper').append('<div class="footer clr"><button class="ok gbutton ' + this.options.okClass + ' gbutton-small">' + this.options.okText + '</button></div>')
                element.find('.footer').append('<button class="cancel gbutton gbutton-small">' + this.options.cancelText + '</button>')
            }
            //是否显示头部
            ...
            this.options.cssClass && element.addClass(css\1_(this.options.cssClass)
        ...
        __offset: function () {
            ...
            if (css\2_(this.element.css('position') != 'fixed') {
